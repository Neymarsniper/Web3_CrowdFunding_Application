...
const menuList = ["White Paper", "Project", "Donation", "Members"];
 return(
  <div class="backgroundMain ">
     <div class="px-4 ру-5 mx-auto sm::max-w-xl md : max-w-full lg:max-w-screen-xl
    md:px-24 lg:px-8">
...
<ul class="flex items-center hidden space-x-8 lg:flex">
 ...
 {/* {!currentAccount && (
<ul class="flex items-center hidden space-x-8 1g:flex">
<li>
...
>
 ...
 {!currentAccount && (
    ...
    title = "Open Menu"
    class="p-2 -mr-1 transition duration-20@ rounded focus:outline-none
    focus: shadowSout Line"
...
0,1.4C4.5,l9.9,4.7,20,5,20s0.5-0.1,0.7-0.3l6.3-6.3l6.3,6.
3c0.2,0.2,0.5,0.3,0.7,0.350.5-0.1,0.7-0.3 c0.4-0.4,0.4-1,
Q-1.4L13.4,12l6.3-6.3C20.1,5.3,20.1,4.7,19.7,4.3z"
/>
</svg>
</button>
</div>
...
transition duration-20@ rounded shadow-md
bg-deep-purple-accent-400 hover: bg-deep-purple-accent-700
